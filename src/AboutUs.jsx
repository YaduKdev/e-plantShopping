  ...
  return (
    <div className="about-us-container">
      ...
      <p className="about-us-description">
        Welcome to Greenday Plants, where we help make the world green again!
      </p>
      <p className="about-us-content">
        At Greenday Plants, we offer a wide variety of lush, healthy plants,
        ...
        flourish. Whether you're an experienced gardener or just starting your
        green journey, Greenday Plants is your trusted partner in cultivating a
        verdant and thriving oasis. Join our community of plant enthusiasts and
        let Greenday Plants help you grow a greener world.
      </p>
      ...
      <p className="about-us-content">
        ...
        Greenday Plants today and experience the beauty of nature right at your
        doorstep.
      </p>
    </div>
  );
